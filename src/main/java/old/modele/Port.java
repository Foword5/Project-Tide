...
public class Port implements Comparable <Port>, Serializable{
	 ...
	 */
	private UiMareeJour[][] marees = new UiMareeJour[12][31];
	...
	public Port(String parNom) {
		...
		for(int i=0;i<marees.length;i++) {
			for(int j=0;j<marees[i].length;j++) {
				marees[i][j] = new UiMareeJour(new String[] {"--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--"});
			}
		}
	}
	 ...
	 */
	public void setJour(int jour, int mois, UiMareeJour mareeJour) {
	 ...
	 */
	public void setMois(int mois, UiMareeJour[] mareeJour) {
	 ...
	 * @return la MareeJour
	 */
	public UiMareeJour getValue(int jour,int mois){
