...
public class UiMareeJour {
	 ...
	 */
	public UiMareeJour(String[] parHeuresPleineMer,String[] parHauteursPleineMer, String[] parHeuresBasseMer, String[] parHauteursBasseMer, String[] parCoefficient, String[] parHauteursMer){
	 ...
	 * @param parCoefficient Liste des deux possibles coefficient de la journ�e
	 */
	public UiMareeJour(String[] parHeuresPleineMer,String[] parHauteursPleineMer, String[] parHeuresBasseMer, String[] parHauteursBasseMer, String[] parCoefficient) {
		heuresPleineMer = parHeuresPleineMer;
		hauteursPleineMer = parHauteursPleineMer;
		heuresBasseMer = parHeuresBasseMer;
		hauteursBasseMer = parHauteursBasseMer;
	 ...
	 */
	public UiMareeJour(String[] parHauteursMer){
