...
public class MenuBar extends JMenuBar{
	 ...
	 * @param parPorts
	 */
	public MenuBar(FenetreMere fenetreMere, String[] parPorts) {
		...
		contact.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent evt){
				try {
					FenetreMere.playSound("src/main/resources/son/Démarrage navigation.wav");
		...
		aide.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent evt){
				if ( SwingUtilities.isLeftMouseButton (evt) ) {
            		...
            		ImageIcon icon = new ImageIcon("src/main/resources/image/infoSecret.png");
            		...
            		try {
            			fenetreMere.dispose();
						FenetreMere.playSound("src/main/resources/son/aide2.wav");
					} catch (UnsupportedAudioFileException | IOException | LineUnavailableException e) {
						e.printStackTrace();
					}
		...
		quitter.addMouseListener(new MouseAdapter(){
			public void mousePressed(MouseEvent e){
				try {
					FenetreMere.playSound("src/main/resources/son/Arrêt.wav");
	...
	public void contact() { 
		...
		Object[] message = {
				...
				"                             "};
		JOptionPane.showMessageDialog(null,message,"Contact",JOptionPane.INFORMATION_MESSAGE,new ImageIcon("src/main/resources/image/email.png"));
	}
